...
pacman -S alsa-utils mpd-archphile mpc mympd-archphile archphile-optimize-rpi4 upmpdcli-archphile shairport-sync brutefir alsacap librespot-archphile squeezelite-archphile sox --noconfirm
...
wget https://raw.githubusercontent.com/archphile/recipe/master/files/config-rpi4.txt -O /boot/config.txt
}
